...
class DeleteAccountBottomSheet extends StatelessWidget {
  ...
  bool? multi = false;
  var domainId;
  DeleteAccountBottomSheet({this.emails,required this.recordId,this.domainId,this.multi,this.email});
  @override
                ...
                children: [
                  ...
                  Expanded(
                    child:value.isLoading == false? CustomElevatedButton(
                      ...
                      onPressed: () async {
                        value.deleteDNS(
                            context, domainId: domainId.toString(), recordId: recordId.toString()
                        );
                      },
                      isPrimaryBackground: false,
                    ) : Container(
